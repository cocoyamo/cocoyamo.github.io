...
<div style="display: flex; align-items: flex-start;">
  ...
  <div style="flex: 1; max-width: 600px; padding-right: 20px;">
    🌐 <a href="https://cocoyamo.github.io/R_tutorials/">Web Tutorial</a>: Covering key topics like data import, cleaning, visualization, and statistical analysis using <strong>tidyverse</strong> and <strong>ggplot2</strong>.
  ...
  <div style="flex: 0 0 auto; text-align: right;">
    <iframe style="width: 336px; height: 189px;" src="https://www.youtube.com/embed/Vz9oN1GU61U" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
</div>
